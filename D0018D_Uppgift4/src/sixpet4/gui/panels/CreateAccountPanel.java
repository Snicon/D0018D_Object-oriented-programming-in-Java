...
public class CreateAccountPanel extends BasePanel {
    ...
    private Customer[] getAllCustomers() {
        ...
        List<String[]> allCustomerData = super.getBankLogic().getAllCustomers();
    	...
    	if (selectedCustomerIndex >= 0 && selectedCustomerIndex < customerList.size()) { // Making sure the customer index is valid
        	...
        	switch (selectedAccountType) {
	    		case AccountType.CREDIT:
	    			accountCreated = super.getBankLogic().createCreditAccount(personalNumber); // Setting accountCreated to the output of the createCreditAccount call
	    			break;
	    		case AccountType.SAVINGS:
	    			accountCreated = super.getBankLogic().createSavingsAccount(personalNumber); // Setting accountCreated to the output of the createSavingsAccount call
	    			break;
        	}
